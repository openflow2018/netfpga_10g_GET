...
#define OF_NUM_PKTS_DROPPED_0_REG                OF_BASE_ADDR+0x00 // 32 bits
...
#define OF_STATS_BASE_REG                        OF_BASE_ADDR+0x3c // 64 bits

//-- Extra registers - by An Nguyen Viet
#define ATTACKER_IP 							 OF_BASE_ADDR+0x3e // 32 bits
#define OF_EXTRA_REG_1 							 OF_BASE_ADDR+0x3f
#define OF_EXTRA_REG_2 							 OF_BASE_ADDR+0x40
#define OF_EXTRA_REG_3 							 OF_BASE_ADDR+0x41
