...
//                System.out.println("Not updating value in 0x"+v);
        ...
        for(int j=0; j<4*8; j+=4){
            int addr_rem = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_BYTES_REMOVED_PORT_0+j;
            int addr_str = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_BYTES_STORED_PORT_0+j;
