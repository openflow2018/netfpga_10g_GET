...
public abstract class AbstractRouterQuickstartFrame extends JInternalFrame {
    ...
    private void setupStatsTable(NFDevice nf2) {
        ...
        aAddresses[0] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_RX_ENQUEUED_PKTS;
        aAddresses[1] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_1_RX_ENQUEUED_PKTS;
        aAddresses[2] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_2_RX_ENQUEUED_PKTS;
        aAddresses[3] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_3_RX_ENQUEUED_PKTS;

        aAddresses[4] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_TX_DEQUEUED_PKTS;
        aAddresses[5] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_1_TX_DEQUEUED_PKTS;
        aAddresses[6] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_2_TX_DEQUEUED_PKTS;
        aAddresses[7] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_3_TX_DEQUEUED_PKTS;

        /* the MAC output queues are the even numbered queues */
        aAddresses[8] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_RX_PKTS_DROPPED;
        aAddresses[9] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_1_RX_PKTS_DROPPED;
        aAddresses[10] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_2_RX_PKTS_DROPPED;
        aAddresses[11] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_3_RX_PKTS_DROPPED;
