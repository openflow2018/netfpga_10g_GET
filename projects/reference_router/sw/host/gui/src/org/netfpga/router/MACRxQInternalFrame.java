...
//        buttons[NFDeviceConsts.XPAR_XBRAM_NUM_INSTANCES] = this.resetMacButton;
//        buttons[NFDeviceConsts.MAC_GRP_MAC_DIS_JUMBO_RX_BIT_NUM] = this.enableJumboCheckBox;
//        buttons[NFDeviceConsts.XPAR_MICROBLAZE_MMU_DTLB_SIZE] = this.enabledCheckbox;
//        invert[NFDeviceConsts.XPAR_MICROBLAZE_MMU_DTLB_SIZE] = true;

        int indexDif = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_1_RESET_CNTRS - NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_RESET_CNTRS;
        ctrlRegGrp = new ControlRegGroup(nf2, NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_RESET_CNTRS+indexDif*index,
                                          buttons, invert);
    ...
    private void setupStatsTable(NFDevice nf2, int index) {
        ...
        long indexDif = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_1_RESET_CNTRS - NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_RESET_CNTRS;
        aAddresses[0] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_RX_ENQUEUED_PKTS;
        aAddresses[1] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_RX_ENQUEUED_BYTES;
        aAddresses[2] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_BAD_FRAMES_COUNTER;
        aAddresses[3] = NFDeviceConsts.XPAR_NF10_10G_INTERFACE_0_RX_PKTS_DROPPED;
