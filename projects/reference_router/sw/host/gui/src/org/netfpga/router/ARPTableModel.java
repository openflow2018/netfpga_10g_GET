...
public class ARPTableModel extends AbstractTableModel {
    ...
    public ARPTableModel(NFDevice nf2){
        ...
        table = new Object[NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ARP_TABLE_DEPTH][COLUMN_NAMES.length];

        for(int i=0; i<NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ARP_TABLE_DEPTH; i++){
        ...
        addresses[ARP_TABLE_IP_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_ARP_IP;
        addresses[ARP_TABLE_MAC_HI_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_ARP_MAC_HIGH;
        addresses[ARP_TABLE_MAC_LO_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_ARP_MAC_LOW;

        /* instantiate the table and add the listener */
        arpTableModel = new WideRegTableModel(nf2, addresses,
                                              NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_ARP_WR_ADDR,
                                              NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_ARP_RD_ADDR,
                                              NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ARP_TABLE_DEPTH);
    ...
    public int getRowCount() {
        return NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ARP_TABLE_DEPTH;
    }
