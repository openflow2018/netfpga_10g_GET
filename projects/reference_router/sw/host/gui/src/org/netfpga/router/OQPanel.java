...
//                NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_PKT_IN_QUEUE_PORT_0+index*512);
...
//        buttons[NFDeviceConsts.OQ_INITIALIZE_OQ_BIT_NUM] = this.resetOQButton;
        ctrlRegGrp = new ControlRegGroup(nf2, NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_RESET_CNTRS+index*512,
                                          buttons, invert);
//
...
//                oqByteSizeSliderCtrl.updateFromRegs();
    ...
    private void setupStatsTable(NFDevice nf2, int index) {
        ...
        index = index* 32;
        aAddresses[0] = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_PKT_STORED_PORT_0 + index;
        aAddresses[1] = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_BYTES_STORED_PORT_0 + index;
        aAddresses[2] = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_PKT_REMOVED_PORT_0 + index;
        aAddresses[3] = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_BYTES_REMOVED_PORT_0 + index;
        aAddresses[4] = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_PKT_DROPPED_PORT_0 + index;
        aAddresses[5] = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_PKT_IN_QUEUE_PORT_0 + index;
        aAddresses[6] = NFDeviceConsts.XPAR_NF10_BRAM_OUTPUT_QUEUES_0_BYTES_IN_QUEUE_PORT_0 + index;
