...
public class InterfacePortConfigTableModel extends AbstractTableModel {
    ...
    public InterfacePortConfigTableModel(NFDevice nf2){
        ...
        /* port mac addresses */
        long[] addresses = {
                NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_0_HIGH,
                NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_0_LOW,
                NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_1_HIGH,
                NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_1_LOW,
                NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_2_HIGH,
                NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_2_LOW,
                NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_3_HIGH,
                NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR0_MAC_3_LOW
        };
        ...
        addresses[0] = NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_FILTER_IP;

        /* instantiate the ip table and add the listener */
        ipTableModel = new WideRegTableModel(nf2, addresses,
                                             NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_FILTER_WR_ADDR,
                                             NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_FILTER_RD_ADDR,
                                             NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_DST_IP_FILTER_TABLE_DEPTH);
        ...
        ipTableModel.addTableModelListener(new TableModelListener() {
             ...
             */
            public void tableChanged(TableModelEvent e) {
                if(e.getFirstRow()>=NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_DST_IP_FILTER_TABLE_DEPTH-NUM_IFACES){
                    updateIPAddresses();
                    fireTableDataChanged();
                }
            }
