...
public class RoutingTableModel extends AbstractTableModel {
    ...
    private static final String[] COLUMN_NAMES = { "Modified", "Index", "Destination IP Addr",
            "Subnet Mask", "NextHop IP Addr", "MAC0", "MAC1", "MAC2", "MAC3", "CPU"};
    ...
    public static final int OUTPUT_MAC_1_COL = 6;
    //public static final int OUTPUT_CPU_1_COL = 8;
    public static final int OUTPUT_MAC_2_COL = 7;
    //public static final int OUTPUT_CPU_2_COL = 10;
    public static final int OUTPUT_MAC_3_COL = 8;
    public static final int OUTPUT_CPU_0_COL = 9;
    ...
    public RoutingTableModel(NFDevice nf2){
        ...
        table = new Object[NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ROUTE_TABLE_DEPTH][COLUMN_NAMES.length];

        for(int i=0; i<NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ROUTE_TABLE_DEPTH; i++){
            ...
            for(int j=OUTPUT_MAC_0_COL; j<=OUTPUT_CPU_0_COL; j++){
        ...
        addresses[RT_TABLE_NEXT_HOP_IP_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_LPM_NEXT_HOP_IP;
        addresses[RT_TABLE_OUTPUT_PORTS_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_LPM_OQ;
        addresses[RT_TABLE_SUBNET_IP_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_LPM_IP;
        addresses[RT_TABLE_SUBNET_MASK_COL-WideRegTableModel.VALUES_START_COL] = NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_LPM_IP_MASK;

        /* instantiate the table and add the listener */
        routingTableModel = new WideRegTableModel(nf2, addresses,
                                              NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_LPM_WR_ADDR,
                                              NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_BAR1_LPM_RD_ADDR,
                                              NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ROUTE_TABLE_DEPTH);
            ...
            public void tableChanged(TableModelEvent e) {
                ...
                for(int i=startRow; i<=endRow; i++){
                    if(i!=TableModelEvent.HEADER_ROW){
                        ...
                        for(int j=OUTPUT_MAC_0_COL, shift=0; j<=OUTPUT_CPU_0_COL; j++, shift++){
    ...
    public int getRowCount() {
        return NFDeviceConsts.XPAR_NF10_ROUTER_OUTPUT_PORT_LOOKUP_0_ROUTE_TABLE_DEPTH;
    }
    ...
    public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
        ...
        if (columnIndex >= OUTPUT_MAC_0_COL && columnIndex <= OUTPUT_CPU_0_COL) {
    ...
    public void clear(int selectedRow) {
        ...
        for(int i = OUTPUT_MAC_0_COL; i<= OUTPUT_CPU_0_COL; i++){
